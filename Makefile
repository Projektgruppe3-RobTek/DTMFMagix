CC=clang++ #Compiler
CFLAGS= -c -std=c++11 -w    -fPIE   #Compiler Flags
DEFINES=
...
SOURCES= AppLayer.cpp DTMFTones.cpp Player.cpp Recorder.cpp main.cpp Goertzel.cpp PhysicalLayerEmu.cpp DataLinkLayer.cpp mythread.cpp moc_dtmfmagix.cpp dtmfmagix.cpp autoCompletion.cpp moc_mythread.cpp #cpp files
